            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@fiero.org'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'pv-cin-cdom-01.fiero.org pv-cin-cdom-05.fiero.org')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=fiero,dc=org'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'sgvc'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'fn1d2f13r0'),
